                ...
                <div class="row">
                    <div class="col-md-12">
                        <h3 class="text-center">Areas</h3>
							<button class="btn btn-success" type="button" id="btn_area"><i class="fa fa-plus"></i> Agregar</button>
                        <hr>
                    </div>
                </div>
                <br>
            </div>
			<div class="table-responsive" id="lista_area">
				<div class="text-center"><i class="fa fa-circle-o-notch fa-spin fa-3x"></i></div>
			</div>
			<div class="container">
				<?php include("forms/areas.php");?>
			</div>
			<!-- /#page-wrapper --> 
		</div>
		<!-- /#wrapper -->
